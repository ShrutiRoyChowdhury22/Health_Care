...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float totalAmount = 0;
        ArrayList dbDate = db.getCartData(username, "medicine");
        Toast.makeText(getApplicationContext(), "" + dbDate, Toast.LENGTH_SHORT).show();
        ...
        for (int i = 0; i < dbDate.size(); i++) {
            ...
            String[] strDate = arrDate.split(java.util.regex.Pattern.quote("$"));
